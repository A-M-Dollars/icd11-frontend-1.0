...
const Loader = () => {
    ...
    return (
        <div className={`fixed inset-0 flex items-center bg-gray-200 justify-center transition-opacity duration-500 ${isLoading ? 'opacity-100' : 'opacity-0'
            }`}>

            <div className="relative z-10 text-center text-lg text-blue-600">

                {/* Progress bar */}
                <div className="w-80 mx-auto mb-4">
                    <div className="bg-white bg-opacity-20 rounded-full h-2 backdrop-blur-sm">
                        <div
                            className="bg-[#007EFF] h-2 rounded-full transition-all duration-600 ease-in"
